-- Termwrapper configuration written in lua

table.insert(plugins, { address = "oberblastmeister/termwrapper.nvim", config = function()

local termwrapper = require('termwrapper')

--termwrapper.TermWrapperConfig.log = 1

require"termwrapper".setup {
    -- these are all of the defaults
    open_autoinsert = true, -- autoinsert when opening
    toggle_autoinsert = false, -- autoinsert when toggling
