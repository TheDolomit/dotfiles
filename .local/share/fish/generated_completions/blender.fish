...
complete -c blender -l python-use-system-env --description 'br Allow Python to use system environment variables such as \'PYTHONPATH\' and …'
...
complete -c blender -l debug-depsgraph-uuid --description 'br Enable debug messages from dependency graph related on graph construction.'
...
complete -c blender -l debug-xr --description 'br Enable debug messages for virtual reality contexts.'
complete -c blender -l debug-xr-time --description 'br Enable debug messages for virtual reality frame rendering times. br.'
...
complete -c blender -l debug-exit-on-error --description 'br Immediately exit when internal errors are detected. br.'
...
complete -c blender -l verbose --description 'br Set the logging verbosity level for debug messages that support it. br.'
